...
namespace Chess.Models.Base
{
    ...
    public abstract class ChessPiece
    {
        ...
        public bool Capture(ChessPiece pieceToCapture)
        {
        ...
        /// <summary>
        /// Method to be implemented that detects what ChessPieces in the current ChessBoard
        /// can be captured, based on the current position of this ChessPiece.
        /// </summary>
        /// <returns>true if one or more captures are possible</returns>
        protected abstract bool CheckAvailableCaptures();
